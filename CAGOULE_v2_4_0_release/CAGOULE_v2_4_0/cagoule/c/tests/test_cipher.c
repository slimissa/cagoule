/**
 * test_cipher.c — Tests du pipeline CBC CAGOULE v2.4.0
 *
 * Usage :
...
static void test_guards(void) {
    ...
    CHECK(cagoule_cbc_encrypt(NULL, 1, out, ct_size, g_mat, &g_sbox, g_round_keys, NUM_KEYS, P)
          == CAGOULE_ERR_NULL, "encrypt NULL padded");
    CHECK(cagoule_cbc_encrypt(plain, 1, NULL, 0, g_mat, &g_sbox, g_round_keys, NUM_KEYS, P)
          == CAGOULE_ERR_NULL, "encrypt NULL out");
    CHECK(cagoule_cbc_encrypt(plain, 4, out, 0, g_mat, &g_sbox, g_round_keys, NUM_KEYS, P)
          == CAGOULE_ERR_SIZE, "encrypt out_size=0");
    CHECK(cagoule_cbc_decrypt(NULL, 1, plain, sizeof(plain), g_mat, &g_sbox, g_round_keys, NUM_KEYS, P)
          == CAGOULE_ERR_NULL, "decrypt NULL cipher");
    CHECK(cagoule_cbc_decrypt(out, 4, NULL, 0, g_mat, &g_sbox, g_round_keys, NUM_KEYS, P)
...
int main(void) {
    printf("══════════════════════════════════════════\n");
    printf("  CAGOULE v2.4.0 — test_cipher.c\n");
    printf("══════════════════════════════════════════\n");
