"""
cipher.py — Chiffrement CAGOULE v2.3.0
    ...
    if CAGOULE_C_AVAILABLE and _lib is not None:
        ...
        if mat_ptr is not None and sbox_ptr is not None:
            ...
            if ret == CAGOULE_OK:
                ...
                # P4: Zeroize input buffer (contains plaintext)
    ...
    if CAGOULE_C_AVAILABLE and _lib is not None:
        ...
        if mat_ptr is not None and sbox_ptr is not None:
            ...
            if ret == CAGOULE_OK:
                ...
                # P4: Zeroize input buffer (contains ciphertext)
...
def encrypt(plaintext: bytes | str, password: bytes | str,
    ...
    """
    Chiffre plaintext avec CAGOULE v2.3.0.
