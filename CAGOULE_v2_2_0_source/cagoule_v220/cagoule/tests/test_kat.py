"""test_kat.py — Known Answer Tests CAGOULE v2.2.0
...
avec la spécification de référence (KAT v2.2.0).
"""
...
class TestKATParameters:
    ...
    def test_version(self, kat):
        ...
        assert kat["version"] in ["2.0", "2.1.0", "2.2.0"], f"Version KAT incorrecte: {kat['version']}"
