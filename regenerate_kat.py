#!/usr/bin/env python3
"""
regenerate_kat.py — Régénération des vecteurs KAT — CAGOULE v2.3.0  
...
def banner():
    print("═" * 60)
    print("  regenerate_kat.py — CAGOULE v2.3.0")
...
def main():
    global _nonce_counter
    parser = argparse.ArgumentParser(description="Régénération KAT CAGOULE v2.3.0")
