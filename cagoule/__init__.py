"""
CAGOULE v2.4.0 — Cryptographie Algébrique Géométrique par Ondes et Logique Entrelacée
...
__backend__ = "C (libcagoule.so v2.4.0)" if _C_AVAILABLE else "Python pur (fallback v2.4.0)"
