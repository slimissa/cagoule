/**
 * test_sbox_avx2.c — Validation de cagoule_sbox_avx2.h — CAGOULE v2.3.0
 *
 * Tests :
...
/* Déltas de test pour init S-box */
...
int main(void) {
    printf("══════════════════════════════════════════════════════\n");
    printf("  test_sbox_avx2 — CAGOULE v2.3.0\n");
    printf("══════════════════════════════════════════════════════\n");
    ...
    if (__builtin_cpu_supports("avx2"))
        ...
        printf("  CPU AVX2 : ✗ non supporté — parité ignorée\n");
#else
