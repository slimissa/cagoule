/**
 * test_omega.c — Tests unitaires cagoule_omega — CAGOULE v2.3.0
 *
...
static void test_openssl(void)
{
    ...
    if (!avail) {
        printf("  SKIP — OpenSSL non disponible (fallback Python possible)\n");
        _pass++;  // count as passed since it's optional
        return;
    }
...
static void test_performance(void)
{
    ...
    if (!under_valgrind && (ms / 100.0) > 50.0) {
...
{
    printf("════════════════════════════════════════════════════════\n");
    printf("  test_omega — CAGOULE v2.3.0\n");
    printf("════════════════════════════════════════════════════════\n");
