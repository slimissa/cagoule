"""
decipher.py — Déchiffrement CAGOULE v2.3.0
...
def _backend_str() -> str:
    return "C (libcagoule.so v2.3.0)" if CAGOULE_C_AVAILABLE else "Python pur (fallback)"
...
def decrypt(ciphertext: bytes, password: bytes | str,
    ...
    """
    Déchiffre un message CAGOULE v2.3.0 au format CGL1.
